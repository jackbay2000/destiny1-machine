...
echo.
echo [2/3] Downloading ViGEmBus driver...
...
:: ── Step 3: chiaki-ng ─────────────────────────────────────────────────────────
echo.
echo [3/3] Downloading chiaki-ng (this may take a moment)...
...
echo   3. Run run.bat before opening chiaki-ng
echo   4. Double-click run.bat to start playing
echo ============================================
pause
